...
@Qualifier("sms")
@Component
public class NotificadorSMSDesambiguacaoViaQualifier implements NotificadorDesambiguacaoViaQualifier {

	@Override
	public void notificar(Cliente cliente, String mensagem) {
		System.out.printf("Notificando [Via Qualifier] [%s] através do SMS [%s]: [%s]\n", 
