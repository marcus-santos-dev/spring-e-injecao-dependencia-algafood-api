...
/**
 * Se não informarmos que essa anotação pode ser lida em tempo de execução (RUNTIME)
 * esta anotação seria desconsiderada
 */
...
public @interface TipoDoNotificador {
	...
	/**
	 * Ao definir a propriedade value [NivelUrgencia value()]
	 * significa que ao usar o TipoDoNotificador você pode suprimir o value,
	 * ou seja, onde antes teriamos que ter @TipoDoNotificador(value = NivelUrgencia.URGENTE)
	 * agora podemos ter @TipoDoNotificador(NivelUrgencia.URGENTE) o que é mais elegante e 
	 * menos verboso.
	 */
	NivelUrgencia value();
