...
@Component
public class NotificadorSMSDesambiguacaoViaAnotacaoCustomizada implements NotificadorDesambiguacaoViaAnotacaoCustomizadaEProfile {

	@Override
	public void notificar(Cliente cliente, String mensagem) {
		System.out.printf("Notificando [Via Anotação Customizada] [%s] através do SMS [%s]: [%s]\n", 
