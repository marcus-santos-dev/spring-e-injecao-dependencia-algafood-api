...
@Primary
@Component
public class NotificadorEmailDesambiguacaoViaPrimary implements NotificadorDesambiguacaoViaPrimary {
	
	@Override
	public void notificar(Cliente cliente, String mensagem) {
		System.out.printf("Notificando [Via Primary] [%s] através do e-mail [%s]: [%s]\n", 
