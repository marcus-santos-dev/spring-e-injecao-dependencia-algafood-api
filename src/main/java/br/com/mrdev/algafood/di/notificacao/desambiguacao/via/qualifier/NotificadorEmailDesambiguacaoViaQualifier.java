package br.com.mrdev.algafood.di.notificacao.desambiguacao.via.qualifier;
...
@Qualifier("email")
@Component
public class NotificadorEmailDesambiguacaoViaQualifier implements NotificadorDesambiguacaoViaQualifier {

	@Override
	public void notificar(Cliente cliente, String mensagem) {
		System.out.printf("Notificando [Via Qualifier] [%s] através do e-mail [%s]: [%s]\n", 
